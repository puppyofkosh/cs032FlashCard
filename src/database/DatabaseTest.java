...
public class DatabaseTest {
	...
	/**
	 * Write a card to database, make sure everything was written properly and that we can change values
	 * @throws IOException
	 * @throws InterruptedException
	 */
	@Test
	public void testWriting() throws IOException, InterruptedException {
