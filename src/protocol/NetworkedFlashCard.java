...
/**
 * Stores the meta data about a flashcard locally, but also store a connection
 * to a server so we can download the audio stuff
 * 
 * @author puppyofkosh
 * 
 */
public class NetworkedFlashCard extends AbstractFlashCard implements
		Serializable {
	...
	public AudioFile getQuestionAudio() {
		throw new UnsupportedOperationException(
				"Audio file does not exist locally");
	}
